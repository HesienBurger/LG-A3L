...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",2500],["cocainu",1500],["cocaine",3500],["cannabis",2500],["opium",2500],["marijuana",2000],["turtle",3000],["blastingcharge",10000],["boltcutter",500]];
...
// Rubber bullets magazines
life_rubbermags = [
	"16Rnd_9x21_Mag"
];
// Vehicles which eject on shot by tazer or rubber bullets
life_ejectvehicle = [
	"B_Quadbike_01_F",
	"C_Kart_01_F",
	"C_Kart_01_Blu_F",
