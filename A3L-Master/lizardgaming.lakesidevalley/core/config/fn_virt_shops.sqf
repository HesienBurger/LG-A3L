...
switch (_shop) do
{
	...
	case "heroin": {["Drug Dealer",["cocaine","heroinp","marijuana"]]};
	...
	case "Teardrop Bar": {["Teardrop Bar",["Dawsey's Beer","Jamal's Gin","Connor's Vodka","Wild Whiskey","Harry's Ale"]]};
	case "uranium": {["Uranium Specialist",["uraniumr","pickaxe","prayer"]]};
	case "drugstore": {["Wacky Drugs",["camonet","seedcan","seedcoc","seedopi","shovel","fertilizer","generator","lightdouble"]]};
