...
switch (_var) do
{
	...
	case "life_inv_beer": {"Dawsey's Beer"};
	case "life_inv_gin": {"Jamal's Gin"};
	case "life_inv_vodka": {"Connor's Vodka"};
	case "life_inv_whiskey": {"Wild Whiskey"};
	case "life_inv_ale": {"Harry's Ale"};
	case "life_inv_zipties": {"Zipties"};
	case "life_inv_fertilizer": {("Fertilizer")};
	case "life_inv_generator": {("Generator")};
	case "life_inv_lightdouble": {("Double Lights")};
	case "life_inv_seedcan": {("Cannabis Seeds")};
	case "life_inv_seedcoc": {("Coca Seeds")};
	case "life_inv_seedopi": {("Opium Seeds")};
	case "life_inv_shovel": {("Shovel")};
	case "life_inv_camonet": {("Netting")};
	case "life_inv_cocainu": {("Coca Leaves")};
	case "life_inv_cocaine": {("Cocaine")};
	case "life_inv_uranium": {("Uranium")};
	case "life_inv_uraniumr": {("Refined Uranium")};
	case "life_inv_prayer": {("Dealing With Insanity")};
	//License Block
