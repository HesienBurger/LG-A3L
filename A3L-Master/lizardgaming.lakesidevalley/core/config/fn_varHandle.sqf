...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "Dawsey's Beer": {"life_inv_beer"};
			case "Jamal's Gin": {"life_inv_gin"};
			case "Connor's Vodka": {"life_inv_vodka"};
			case "Wild Whiskey": {"life_inv_whiskey"};
			case "Harry's Ale": {"life_inv_ale"};
			case "Zipties": {"life_inv_zipties"};
			case "fertilizer": {"life_inv_fertilizer"};
			case "generator": {"life_inv_generator"};
			case "lightdouble": {"life_inv_lightdouble"};
			case "seedcan": {"life_inv_seedcan"};
			case "seedcoc": {"life_inv_seedcoc"};
			case "seedopi": {"life_inv_seedopi"};
			case "shovel": {"life_inv_shovel"};
			case "camonet": {"life_inv_camonet"};
			case "cocainu": {"life_inv_cocainu"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_lightdouble": {"lightdouble"};
			case "life_inv_seedcan": {"seedcan"};
			case "life_inv_seedcoc": {"seedcoc"};
			case "life_inv_seedopi": {"seedopi"};
			case "life_inv_shovel": {"shovel"};
			case "life_inv_camonet": {"camonet"};
			case "life_inv_cocainu": {"cocainu"};
