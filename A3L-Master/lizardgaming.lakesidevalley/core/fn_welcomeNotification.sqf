...
[
	"Welcome Evolution RP! A few things have changed with Evolution RPG that you need to be aware of!",
	...
	"You can find all the rest of our keys in the key bindings tab in the map",
