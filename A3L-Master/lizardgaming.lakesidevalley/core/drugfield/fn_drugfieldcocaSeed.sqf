...
[getPos _tent, "cocainu", _number, false] call life_fnc_itemDrop;
life_action_cocaPickup = player addAction["Pickup Coca",life_fnc_pickupCoca,"",0,false,false,"",
' _can = nearestObjects[getPos player,["Land_Basket_F"],8] select 0; !isNil "_can" && !isNil {(_can getVariable "item")}'];
