/*
Author: J Macklemore
File: fn_drugfieldopiumSeed.sqf
...
[getPos _tent, "heroinu", _number, false] call life_fnc_itemDrop;
life_action_opiumPickup = player addAction["Pickup Opium",life_fnc_pickupOpium,"",0,false,false,"",
' _can = nearestObjects[getPos player,["Land_CratesWooden_F"],8] select 0; !isNil "_can" && !isNil {(_can getVariable "item")}'];
